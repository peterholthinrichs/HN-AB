...
const colleagues: Colleague[] = [
  { id: "1", name: "Engineer", role: "Calculator", avatar: engineerAvatar },
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-muted-foreground text-sm">{colleague.role}</span>
                  </div>
                </div>
                {colleague.messageCount !== undefined && (
                  <span className="text-sm font-medium text-muted-foreground">{colleague.messageCount}</span>
                )}
              </button>
            );
          })}
